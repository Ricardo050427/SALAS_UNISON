      ...
      <div className={styles.modal} onClick={e => e.stopPropagation()}>
        ...
        <div style={{ padding: '20px', display: 'flex', flexDirection: 'column', gap: '20px' }}>
          ...
          {(() => {
            ...
            const activeColor = SOLID_COLORS[event.color] || 'var(--accent-color)';
            const activeBg = LIGHT_BACKGROUNDS[event.color] || '#fff7ed';

            return (
              <>
                <div style={{ backgroundColor: activeBg, padding: '16px', borderRadius: '8px', borderLeft: `4px solid ${activeColor}` }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'flex-start', gap: '8px' }}>
                    <Calendar size={20} color={activeColor} />
                    <div>
                  ...
                  <div style={{ display: 'flex', alignItems: 'flex-start', gap: '8px' }}>
                    ...
                    <div>
                      ...
                      <span>{formatRooms(event.salasAsignadas)} | {event.numAsistentes} asistentes</span>
                    </div>
                  </div>

                  <div style={{ display: 'flex', alignItems: 'flex-start', gap: '8px' }}>
                    <CheckSquare size={20} color={activeColor} />
                    <div>
                  ...
                  {confirmDelete ? (
                    ...
                    <>
                      ...
                      <button
                        ...
                        style={{ display: 'flex', alignItems: 'center', gap: '6px', padding: '8px 16px', borderRadius: '6px', background: activeColor, border: 'none', color: '#fff', fontWeight: 600, cursor: 'pointer', transition: '0.2s' }}
